...
// Generic Vårdplan - Example medication schedule (no personal data)
const VARDPLAN = {
  medications: [
    {
      name: 'Lithium',
...
export function GenericMedicineLog() {
  ...
  const handleButtonRelease = () => {
    ...
    if (isLongPressing) {
      // Released before 0.5 seconds → quick press
      setIsLongPressing(false);
      handleQuickPress();
    }
  };
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
        ...
        >
          ...
          <button
            ...
            className="w-full py-3 rounded-xl font-bold mb-2 shadow-md hover:opacity-90 transition-opacity"
            style={{
          ...
          <button
            onClick={() => setShowAddMedication(false)}
            className="w-full py-3 rounded-xl font-bold shadow-md hover:opacity-90 transition-opacity"
            style={{
    ...
    return (
      ...
      >
        ...
        <button
          ...
          className="w-full py-3 rounded-xl font-bold mb-4 shadow-md hover:opacity-90 transition-opacity"
          style={{
        ...
        <button
          ...
          className="w-full py-4 rounded-xl text-xl font-bold mb-4 shadow-md hover:opacity-90 transition-opacity"
          style={{
            backgroundColor: COLORS.alliancePurple,
            color: COLORS.birchWhite,
          }}
  ...
  return (
    ...
    >
      ...
      {justLogged && lastLog && (
        <div
          className="rounded-2xl p-6 mb-6 shadow-md animate-pulse"
          style={{
      ...
      <button
        ...
        disabled={justLogged}
        className="w-full py-12 rounded-2xl text-3xl font-bold shadow-lg transition-all select-none"
        style={{
